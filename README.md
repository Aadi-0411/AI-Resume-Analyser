...
Building an AI-powered Resume Analyzer with React, React Router, and Puter.js! Implementing seamless auth, upload and store resumes, and match candidates to jobs using smart AI evaluations. Getting custom feedback and ATS scores tailored to each listing—all wrapped in a clean, reusable UI.
...
```bash
git clone https://github.com/Aadi-0411/AI-Resume-Analyser.git
```
